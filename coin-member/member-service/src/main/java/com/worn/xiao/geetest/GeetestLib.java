...
public class GeetestLib {
    ...
    public static final String GEETEST_SERVER_USER_KEY = "g_s_u_k";
    /**
     * 公钥
     */
    ...
    private String requestRegister(Map<String, String> paramMap) {
        ...
        try {
            ...
            origin_challenge = jsonObject.getStr("challenge");
        } catch (Exception e) {
    ...
    private String requestValidate(String challenge, String validate, String seccode, Map<String, String> paramMap) {
        ...
        try {
            ...
            JSONObject jsonObject = new JSONObject(resBody);
            response_seccode = jsonObject.getStr("seccode");
        } catch (Exception e) {
